...
Java_io_github_javernaut_mediafile_creator_MediaFileBuilder_nativeCreateFromFD(JNIEnv *,
                                                                           jobject instance,
                                                                           jint fileDescriptor,
...
JNIEXPORT void JNICALL
Java_io_github_javernaut_mediafile_creator_MediaFileBuilder_nativeCreateFromAssetFD(JNIEnv *env,
                                                                                jobject instance,
...
JNIEXPORT void JNICALL
Java_io_github_javernaut_mediafile_creator_MediaFileBuilder_nativeCreateFromPath(JNIEnv *env,
                                                                             jobject instance,
                                                                             jstring jFilePath,
                                                                             jint mediaStreamsMask) {
